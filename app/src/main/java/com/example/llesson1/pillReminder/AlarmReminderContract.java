...
/*public class AlarmReminderContract {
    ...
    public static final class AlarmReminderEntry implements BaseColumns{
        ...
        public static final String KEY_PILL_NAME = "pill_name";
        public static final String KEY_HOUR ="hour";
        public static final String KEY_MINUTE = "minute";
        public static final String KEY_DAY_WEEK = "day_of_week";
        public static final String KEY_DOSE_QUANTITY = "dose_quantity";
        public static final String KEY_DOSE_UNITS = "dose_units";
