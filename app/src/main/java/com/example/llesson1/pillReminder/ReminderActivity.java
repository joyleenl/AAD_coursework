...
import com.example.llesson1.pillReminder.alarm.AlarmSchduler;
import com.example.llesson1.pillReminder.data.AlarmReminderContract;
...
public class ReminderActivity extends AppCompatActivity {
    ...
    public class AddReminderActivity extends AppCompatActivity implements
        ...
        private void showUnsavedChangesDialog(
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("Discard changes and quit?");
        ...
        private void deleteReminder() {
            ...
            if (mCurrentReminderUri != null) {
                ...
                if (rowsDeleted == 0) {
                    ...
                    Toast.makeText(this, "Error in Deleting",
...
*/
            ...
            if (mCurrentReminderUri == null) {
                ...
                if (newUri == null) {
                    ...
                    Toast.makeText(this, "error saving reminder",
                            Toast.LENGTH_SHORT).show();
                } else {
                ...
                if (rowsAffected == 0) {
                    ...
                    Toast.makeText(this, "error updating reminder",
                            Toast.LENGTH_SHORT).show();
                } else {
            ...
            if (mActive.equals("true")) {
                if (mRepeat.equals("true")) {
                    new AlarmSchduler().setRepeatAlarm(getApplicationContext(), selectedTimestamp, mCurrentReminderUri, mRepeatTime);
                } else if (mRepeat.equals("false")) {
                    new AlarmSchduler().setAlarm(getApplicationContext(), selectedTimestamp, mCurrentReminderUri);
                }
