...
public class AlarmSchduler {
// Schedule a reminder alarm at the specified time for the given task.
// the param context: Local application or activity context
//the param reminderTask Uri : referencing the task in the content provider
