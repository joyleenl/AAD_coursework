package com.example.llesson1.pillReminder.data;
...
public class MedicineRepository implements MedicineDataSource {
    ...
    private static com.example.llesson1.pillReminder.data.MedicineRepository mInstance = null;
    ...
    public static com.example.llesson1.pillReminder.data.MedicineRepository getInstance(MedicineDataSource localDataSource) {
        if (mInstance == null) {
            mInstance = new com.example.llesson1.pillReminder.data.MedicineRepository(localDataSource);
        }
        return mInstance;
    }
